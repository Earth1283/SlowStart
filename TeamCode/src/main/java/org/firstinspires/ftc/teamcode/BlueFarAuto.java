 ...
 *   2. SHOOTER_TARGET_TICKS_PER_SEC is 0, so atTargetVelocity() is never true and the auto
 *      will WAIT AT THE SHOOT POSE FOREVER by design. Set a real velocity.
 *   3. The four LEFT/RIGHT_GATE_OPEN/CLOSE positions are all 0 -- gates will not move.
